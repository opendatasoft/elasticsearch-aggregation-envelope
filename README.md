...
`./bin/elasticsearch-plugin install https://github.com/opendatasoft/elasticsearch-aggregation-envelope/releases/download/v7.1.0.0/envelope-aggregation-7.1.0.0.zip`
...
| 6.8.0 | 6.8.0.0 | https://github.com/opendatasoft/elasticsearch-aggregation-envelope/releases/download/v6.8.0.0/envelope-aggregation-6.8.0.0.zip |
...
| 7.1.0 | 7.1.0.0 | https://github.com/opendatasoft/elasticsearch-aggregation-envelope/releases/download/v7.1.0.0/envelope-aggregation-7.1.0.0.zip |
