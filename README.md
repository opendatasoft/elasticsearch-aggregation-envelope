...
`./bin/elasticsearch-plugin install https://github.com/opendatasoft/elasticsearch-aggregation-envelope/releases/download/v6.6.0.0/envelope-aggregation-6.6.0.0.zip`
...
| 6.6.0 | 6.6.0.0 | https://github.com/opendatasoft/elasticsearch-aggregation-envelope/releases/download/v6.6.0.0/envelope-aggregation-6.6.0.0.zip |
