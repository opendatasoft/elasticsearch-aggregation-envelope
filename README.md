...
`./bin/elasticsearch-plugin install https://github.com/opendatasoft/elasticsearch-aggregation-envelope/releases/download/v6.4.2.0/envelope-aggregation-6.4.2.0.zip`
...
| 6.4.2 | 6.4.2.0 | https://github.com/opendatasoft/elasticsearch-aggregation-envelope/releases/download/v6.4.2.0/envelope-aggregation-6.4.2.0.zip |
